...
namespace Roslynator.CSharp.Refactorings
{
    internal static class ReplaceForWithForEachRefactoring
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            ImmutableArray<SyntaxNode> nodes = await ReferenceFinder.FindNodesAsync(symbol, document, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            ExpressionSyntax memberAccessExpression)
        {
            ...
            if (symbol != null)
            {
                ...
                ImmutableArray<SyntaxNode> nodes = await ReferenceFinder.FindNodesAsync(variableSymbol, context.Document, cancellationToken: context.CancellationToken).ConfigureAwait(false);
