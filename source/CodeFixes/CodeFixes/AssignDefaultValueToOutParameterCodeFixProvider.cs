...
namespace Roslynator.CSharp.CodeFixes
{
    ...
    public class AssignDefaultValueToOutParameterCodeFixProvider : BaseCodeFixProvider
    {
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (!TryFindFirstAncestorOrSelf(root, context.Span, out SyntaxNode node, f => f.IsKind(SyntaxKind.MethodDeclaration, SyntaxKind.LocalFunctionStatement) || f is StatementSyntax))
                return;
