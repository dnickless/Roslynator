...
namespace Roslynator.CSharp.CodeFixes
{
    ...
    public class TypeDoesNotContainDefinitionCodeFixProvider : BaseCodeFixProvider
    {
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (!TryFindFirstAncestorOrSelf(root, context.Span, out SyntaxNode node, f => f.IsKind(SyntaxKind.AwaitExpression, SyntaxKind.IdentifierName, SyntaxKind.GenericName)))
                return;
