...
namespace Roslynator.CSharp.CodeFixes
{
    ...
    public class AddParenthesesCodeFixProvider : BaseCodeFixProvider
    {
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (!TryFindFirstAncestorOrSelf(root, context.Span, out ExpressionSyntax expression, f => f.IsKind(SyntaxKind.ConditionalExpression) || f is BinaryExpressionSyntax))
                return;
